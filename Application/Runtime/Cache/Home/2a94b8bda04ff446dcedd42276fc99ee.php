...
<head>
	...
	<link rel="stylesheet" href="/demo2/Public/css/bootstrap.css" type="text/css" />
	<link rel="stylesheet" href="/demo2/Public/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="/demo2/Public/css/font-awesome.min.css" type="text/css" />
	<link rel="stylesheet" href="/demo2/Public/css/simple-line-icons.css" type="text/css" />
	<link rel="stylesheet" href="/demo2/Public/css/font.css" type="text/css" />
	<link rel="stylesheet" href="/demo2/Public/css/css.css" type="text/css" />
	<script src="/demo2/Public/js/jquery.min.js"></script>
	<script src="/demo2/Public/js/bootstrap.js"></script>
    ...
    <div class="app-header navbar">
      ...
      <div class="navbar-header bg-dark">
        ...
        <a href="#/" class="navbar-brand text-lt">
          <i class="fa fa-btc"></i>
          <img src="/demo2/Public/img/logo.png" alt="." class="hide">
                ...
                <div class="list-group">
                  <a href class="media list-group-item">
                    <span class="pull-left thumb-sm">
                      <img src="/demo2/Public/img/a0.jpg" alt="..." class="img-circle">
                    </span>
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="/demo2/Public/img/a0.jpg" alt="...">
                <i class="on md b-white bottom"></i>
              </span>
              <span class="hidden-sm hidden-md"><?php echo ($zzz); ?></span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            ...
            <div class="dropdown wrapper">
              <a ui-sref="app.page.profile">
                <span class="thumb-lg w-auto-folded avatar m-t-sm">
                  <img src="/demo2/Public/img/a0.jpg" class="img-full" alt="...">
                </span>
              </a>
